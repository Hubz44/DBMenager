...
from .gui.dbmenager_dockwidget import DBMenagerDockWidget
from .gui.dbmenager_dialog import DBMenagerDialog
import os.path
...
class DBMenager:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&DBMenager')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'DBMenager')
        self.toolbar.setObjectName(u'DBMenager')

        #print "** INITIALIZING DBMenager"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('DBMenager', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Menage your database'),
            callback=self.run,
